...
public class Util {
    ...
    //for verify
        public static void verifyMethod(By by, String  text){

        Boolean checkIfElementPresent= driver.findElements(by).size()!= 0;
        //boolean Error = driver.findElement(by).getText().contains(text);
            if (checkIfElementPresent == true) {
